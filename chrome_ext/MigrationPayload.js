...
(function(global, factory) { /* global define, require, module */
    ...
    $root.MigrationPayload = (function() {
        ...
        MigrationPayload.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            ...
            return typeUrlPrefix + "/MigrationPayload";
        };
        ...
        MigrationPayload.OtpParameters = (function() {
            ...
            OtpParameters.toObject = function toObject(message, options) {
                ...
                if (message.algorithm != null && message.hasOwnProperty("algorithm"))
                    object.algorithm = options.enums === String ? $root.MigrationPayload.Algorithm[message.algorithm] === undefined ? message.algorithm : $root.MigrationPayload.Algorithm[message.algorithm] : message.algorithm;
                if (message.digits != null && message.hasOwnProperty("digits"))
                    object.digits = options.enums === String ? $root.MigrationPayload.DigitCount[message.digits] === undefined ? message.digits : $root.MigrationPayload.DigitCount[message.digits] : message.digits;
                if (message.type != null && message.hasOwnProperty("type"))
                    object.type = options.enums === String ? $root.MigrationPayload.OtpType[message.type] === undefined ? message.type : $root.MigrationPayload.OtpType[message.type] : message.type;
                if (message.counter != null && message.hasOwnProperty("counter"))
            ...
            OtpParameters.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
                ...
                return typeUrlPrefix + "/MigrationPayload.OtpParameters";
            };
